# -*- coding: utf-8 -*-
"""
Created on Wed Aug  3 14:21:22 2022
...
def create_agent_CategoricalDDQN(gamma, exploration_func, epsilon, obs_size,
    ...
    q_func = Q.DistributionalFCStateQFunctionWithDiscreteAction(
        obs_size, n_actions, n_atoms=51, v_min=0, v_max=1,
        n_hidden_channels=n_hidden_channels, n_hidden_layers=n_hidden_layers,

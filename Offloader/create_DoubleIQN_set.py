# -*- coding: utf-8 -*-
"""
Created on Thu Aug  4 11:29:26 2022
...
def create_agent_DoubleIQN(gamma, exploration_func, epsilon, obs_size,
                           n_actions, n_hidden_channels=90,
    ...
    if(type(epsilon) == float or type(epsilon) == int):
        ...
        agent_info = ('DoubleIQN - ' + 'Linear decay ' + chr(949) + '=' +
